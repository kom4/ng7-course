...
export const SET_DELETED_INGREDIENT_INDEX = 'SET_DELETED_INGREDIENT_INDEX';
...
export class SetDeletedIngredientIndex implements Action {
  readonly type = SET_DELETED_INGREDIENT_INDEX;
}
